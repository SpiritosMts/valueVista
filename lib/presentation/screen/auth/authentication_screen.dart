...
import 'package:banking/common/constants.dart';
import 'package:banking/data/repository/repository.dart';
import 'package:banking/presentation/screen/main/home_screen.dart';
import 'package:banking/presentation/widget/components.dart';
...
class _AuthenticationScreenState extends State<AuthenticationScreen> {
  ...
  List<String> logInErrorTexts = List.generate(logInTextFieldProperties.length, (_) => '');
  List<String> signUpErrorTexts = List.generate(signUpTextFieldProperties.length, (_) => '');
  int pageIndex = 0;
            ...
            child: Column(
              ...
              children: [
                Visibility(
                  ...
                  child: Column(
                    children: [
                      Image.asset('lib/assets/images/logo.png',height: 200,width: 200,),
                      Visibility(
                ...
                Visibility(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, field) {
                      if(field == 3 || field == 4) return Container();
                ...
                Visibility(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, field) => customTextField(
                        ...
                        inputFormatters: logInTextFieldProperties[field]['inputFormatters'],
    ...
    setState(() {
      for (int i = 0; i < logInControllers.length; i++) {
        switch (i) {
          ...
          case 1:
            if (logInControllers[i].text.isEmpty) {
              logInErrorTexts[i] = 'PassPhrase is required';
            } else {
              logInErrorTexts[i] = '';
            }
            break;
    ...
    setState(() {
      for (int i = 0; i < signUpControllers.length; i++) {
        switch (i) {
          ...
          case 3:
            if (signUpControllers[i].text.isEmpty) {
              signUpErrorTexts[i] = 'PassPhrase is required';
            } else if (signUpControllers[i]
                        .text
                        .contains(RegExp(r'[!@#$%^&*(),.?":{}|<>]')) &&
          ...
          case 4:
            if (signUpControllers[i].text.isEmpty) {
              signUpErrorTexts[i] = 'Confirm PassPhrase is required';
            } else if (signUpControllers[i].text !=
                signUpControllers[i - 1].text) {
              signUpErrorTexts[i] = 'PassPhrase must be same';
            } else {
              signUpErrorTexts[i] = '';
            }
            break;
